    ...
    <article className="w-full rounded-2xl border border-purple-100 bg-white p-5 shadow">
      <header className="mb-3 flex items-center gap-3">
        <img
          src="/meloIcon.png"
          alt="Melo"
          className="h-15 w-10 rounded-full ring-2 ring-purple-100"
        />
        <div className="flex items-center gap-2">
          <h2 className="text-xl font-semibold text-gray-900">Melo (IA)</h2>
      ...
      <div className="space-y-3 text-sm leading-relaxed text-gray-800">
        ...
        <div className="rounded-xl bg-purple-50/60 p-3 text-[13px]">
          <p className="font-semibold text-purple-900">Acoes recomendadas</p>
